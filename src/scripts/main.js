...
$(document).ready(function(){
  ...
  $('#contact').click(function() {
    ...
    $('.contact-form').toggleClass('active').trigger('formTrigger');
  })

  $('.modal-contact').click(function() {
    $('.m-w').removeClass('active');
    $('.contact-form').addClass('active').trigger('formTrigger');
  })
  ...
  $('.contact-form').on('formTrigger', function() {
    if($(this).hasClass('active')) {
